/* Carbonautas P94 · identidade soft/regenerativa · SOMENTE VISUAL */
(function(){
'use strict';
const BUILD='P94';
...
function useSoftMark(){$$('.brand .logo-img,.app-menu-logo,.loading .logo-img').forEach(img=>{if(img.dataset.softMark==='P94')return;img.dataset.softMark='P94';img.src='./carbonautas-soft-mark.svg?v=P94-20260918';img.alt='Carbonautas · carbono, regeneração, rede e navegação'})}
...
function visualCleanup(){const d=$('#repoDedupeBtn');if(d)d.style.display='none';document.body.classList.add('carbonautas-soft-p93','carbonautas-identity-p94');const meta=$('meta[name="theme-color"]');if(meta)meta.setAttribute('content','#F6FAF9')}
...
function boot(){
  ...
  window.CARBONAUTAS_RUNTIME_BUILD=BUILD;console.info('Carbonautas P94 identidade global carregada')
}
