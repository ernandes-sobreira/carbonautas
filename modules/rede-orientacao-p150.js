...
window.__CARBONAUTAS_P151_ACADEMICO=true;
...
function selected(){try{return selectedId||''}catch(_e){return''}}
function admin(){try{return !!isAdmin}catch(_e){return false}}
function member(id){try{return typeof memberById==='function'?memberById(id):(S().members||[]).find(m=>m.id===id)}catch(_e){return null}}
