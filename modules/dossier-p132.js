/* Carbonautas P178 · carregador sob demanda
...
let redePromise=null,dossierPromise=null,projectsPromise=null,agendaPromise=null,agendaFocusPromise=null,agendaDetailPromise=null,homePolishPromise=null,muralVisualPromise=null,muralPolishPromise=null,highlightsPromise=null,peopleScheduled=false;
...
function route(){
 ...
 if(v==='mural'||v==='feed'){ensureHomePolish();ensureMuralVisual();ensureMuralPolish()}
}
function boot(){
 ...
 document.addEventListener('click',e=>{
  ...
  const mural=e.target.closest?.('#newPostBtn,#muralPostBtn,#muralNewBtn,#mobileMuralFab,#mobileMuralNew,[data-mural-kind],#savePostBtn');if(mural){ensureHomePolish();ensureMuralVisual();ensureMuralPolish()}
