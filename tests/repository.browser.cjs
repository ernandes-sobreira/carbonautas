...
(async()=>{
 ...
 await page.evaluate(()=>{
 window.calls={downloads:0,previews:0,messages:0};const pubs=Array.from({length:3},(_,i)=>({id:'f'+i,tipo:'arquivo',memberId:'alu',fileName:'Documento '+i+'.docx',titulo:'Projeto '+i,url:'https://example.org/a',onlineEditVersion:2,repositoryTurnMemberId:'prof',onlineEditHistory:[{action:'download',version:1,byName:'Professor',savedAt:'2026-09-22T10:00:00Z'}]}));
