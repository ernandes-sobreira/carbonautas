const CACHE='carbonautas-p70-20260917';
...
const SYNC_SCRIPT='<script src="./calendar-sync-v4.js?v=P70-20260917"><\/script>';
const DURATION_SCRIPT='<script src="./calendar-duration-v1.js?v=P70-20260917"><\/script>';
const NOTIFY_SCRIPT='<script src="./notification-fix-v1.js?v=P70-20260917"><\/script>';
const UI_SCRIPT='<script src="./ui-fixes-p44.js?v=P70-20260917"><\/script>';
const ACADEMIC_SCRIPT='<script src="./academic-periods-p45.js?v=P70-20260917"><\/script>';
const CHAT_SCRIPT='<script src="./chat-whatsapp-p46.js?v=P70-20260917"><\/script>';
const PRIVATE_REPO_SCRIPT='<script src="./private-repo-p47.js?v=P70-20260917"><\/script>';
const GROUPS_SCRIPT='<script src="./panelinhas-p48.js?v=P70-20260917"><\/script>';
const TABS_SCRIPT='<script src="./tabs-stability-p50.js?v=P70-20260917"><\/script>';
const AGENDA_BADGE_SCRIPT='<script src="./agenda-badge-p51.js?v=P70-20260917"><\/script>';
const REVIEW_FLOW_SCRIPT='<script src="./review-flow-p52.js?v=P70-20260917"><\/script>';
const REPOSITORY_UI_SCRIPT='<script src="./repository-ui-p54.js?v=P70-20260917"><\/script>';
const REPOSITORY_ACTIONS_SCRIPT='<script src="./repository-actions-p55.js?v=P70-20260917"><\/script>';
const DASH_MEDALS_SCRIPT='<script src="./dashboard-medals-p56.js?v=P70-20260917"><\/script>';
const MOBILE_MEDALS_SCRIPT='<script src="./mobile-medals-p57.js?v=P70-20260917"><\/script>';
const MOBILE_RESCUE_SCRIPT='<script src="./mobile-repo-rescue-p58.js?v=P70-20260917"><\/script>';
const REPO_CHECKIN_UI_SCRIPT='<script src="./repo-checkin-ui-p59.js?v=P70-20260917"><\/script>';
const EDITOR_SAFE_SCRIPT='<script src="./editor-safe-p62.js?v=P70-20260917"><\/script>';
const REPOSITORY_CLEAN_SCRIPT='<script src="./repository-cleanup-p63.js?v=P70-20260917"><\/script>';
const REPOSITORY_PRIVATE_CHAT_SCRIPT='<script src="./repository-private-chat-p64.js?v=P70-20260917"><\/script>';
const REPOSITORY_DELETE_DEDUPE_SCRIPT='<script src="./repository-delete-dedupe-p65.js?v=P70-20260917"><\/script>';
const DASH_ACTION_SCRIPT='<script src="./dashboard-action-detail-p66.js?v=P70-20260917"><\/script>';
const DASH_TARGET_SCRIPT='<script src="./dashboard-action-target-p67.js?v=P70-20260917"><\/script>';
const DASH_CLARITY_SCRIPT='<script src="./dashboard-clarity-p68.js?v=P70-20260917"><\/script>';
const DASH_RESOLVE_SCRIPT='<script src="./dashboard-resolve-flow-p69.js?v=P70-20260917"><\/script>';
const DASH_SMART_REQUEST_SCRIPT='<script src="./dashboard-smart-request-p70.js?v=P70-20260917"><\/script>';
