...
const AGENDA_DECK_SCRIPT='<script src="./agenda-deck-p110.js?v=P110-20260918"><\/script>';
const AGENDA_SWIPE_SCRIPT='<script src="./agenda-swipe-p113.js?v=P114-20260918"><\/script>';
const AGENDA_STABLE_MEDIA_SCRIPT='<script src="./agenda-stable-media-p121.js?v=P121-20260918"><\/script>';
const AGENDA_MOBILE_FIT_SCRIPT='<script src="./agenda-mobile-fit-p120.js?v=P120-20260918"><\/script>';
const AGENDA_NO_FLICKER_SCRIPT='<script src="./agenda-no-flicker-p122.js?v=P122-20260918"><\/script>';
...
async function navigationResponse(req){
  try{
    ...
    if(!html.includes('agenda-deck-p110.js'))inject+=AGENDA_DECK_SCRIPT;
    if(!html.includes('agenda-swipe-p113.js'))inject+=AGENDA_SWIPE_SCRIPT;
    if(!html.includes('agenda-stable-media-p121.js'))inject+=AGENDA_STABLE_MEDIA_SCRIPT;
    if(!html.includes('agenda-mobile-fit-p120.js'))inject+=AGENDA_MOBILE_FIT_SCRIPT;
    if(!html.includes('agenda-no-flicker-p122.js'))inject+=AGENDA_NO_FLICKER_SCRIPT;
