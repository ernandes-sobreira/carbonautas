const CACHE='carbonautas-p50-20260916';
...
const SYNC_SCRIPT='<script src="./calendar-sync-v4.js?v=P50-20260916"><\/script>';
const DURATION_SCRIPT='<script src="./calendar-duration-v1.js?v=P50-20260916"><\/script>';
const NOTIFY_SCRIPT='<script src="./notification-fix-v1.js?v=P50-20260916"><\/script>';
const UI_SCRIPT='<script src="./ui-fixes-p44.js?v=P50-20260916"><\/script>';
const ACADEMIC_SCRIPT='<script src="./academic-periods-p45.js?v=P50-20260916"><\/script>';
const CHAT_SCRIPT='<script src="./chat-whatsapp-p46.js?v=P50-20260916"><\/script>';
const PRIVATE_REPO_SCRIPT='<script src="./private-repo-p47.js?v=P50-20260916"><\/script>';
const GROUPS_SCRIPT='<script src="./panelinhas-p48.js?v=P50-20260916"><\/script>';
const TABS_SCRIPT='<script src="./tabs-stability-p50.js?v=P50-20260916"><\/script>';
