const CACHE='carbonautas-p35-20260914';
...
const SYNC_SCRIPT='<script src="./calendar-sync-v2.js?v=P35-20260914"><\/script>';
const DURATION_SCRIPT='<script src="./calendar-duration-v1.js?v=P35-20260914"><\/script>';
