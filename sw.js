const CACHE='carbonautas-p82-20260917';
const BUILD='P82';
...
const PWA_MOBILE_FIX_SCRIPT='<script src="./pwa-mobile-fix-p82.js?v=P82-20260917"><\/script>';
...
async function navigationResponse(req){
  try{
    ...
    if(!html.includes('pwa-mobile-fix-p82.js'))inject+=PWA_MOBILE_FIX_SCRIPT;
