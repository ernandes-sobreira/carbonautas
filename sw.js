const CACHE='carbonautas-p39-20260915';
...
const SYNC_SCRIPT='<script src="./calendar-sync-v4.js?v=P39-20260915"><\/script>';
const DURATION_SCRIPT='<script src="./calendar-duration-v1.js?v=P39-20260915"><\/script>';
const NOTIFY_SCRIPT='<script src="./notification-fix-v1.js?v=P39-20260915"><\/script>';
