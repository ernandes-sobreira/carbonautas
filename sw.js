const CACHE='carbonautas-p45-20260916';
...
const SYNC_SCRIPT='<script src="./calendar-sync-v4.js?v=P45-20260916"><\/script>';
const DURATION_SCRIPT='<script src="./calendar-duration-v1.js?v=P45-20260916"><\/script>';
const NOTIFY_SCRIPT='<script src="./notification-fix-v1.js?v=P45-20260916"><\/script>';
const UI_SCRIPT='<script src="./ui-fixes-p44.js?v=P45-20260916"><\/script>';
const ACADEMIC_SCRIPT='<script src="./academic-periods-p45.js?v=P45-20260916"><\/script>';
