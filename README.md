...
- Limpa conversa ativa, assinatura de mensagens e resposta em andamento antes de retornar à lista no celular.
- O botão recebe prioridade de toque para evitar captura por outras camadas da interface.
- Não alterado: dados, Firebase, regras, VPS ou privacidade das conversas.
...
- O bloco passa a ser o último item da área de publicações, depois da última mensagem.
- Destaques rolam junto com as publicações e não ficam sobrepostos aos filtros ou ao feed.
- Não alterado: dados, Firebase, regras, VPS ou permissões.

### P198 · 2026-09-20 · Voltar no desktop
- Passa-cards ganham botão circular de voltar no PC.
- Voltar retorna ao card anterior sem dispensar nem alterar dados.
- No celular o botão fica oculto; o swipe para a direita continua sendo o retorno.
- Não alterado: dados, Firebase, regras, VPS ou permissões.

### P197 · 2026-09-20 · Capa mais limpa e swipe leve
- Swipe passa com gesto curto (aprox. 35–58 px) ou movimento rápido, sem exigir força.
- Fontes antigas do painel ficam invisíveis na capa, mas continuam alimentando os cards.
- Remove o AGORA duplicado, melhora hierarquia de título, metadado e descrição.
- Botões recebem visual próprio de app e o próximo vira seta circular.
- Incluída dica discreta ↔ deslize.
- Não alterado: dados, Firebase, regras, VPS ou permissões.
