/* Carbonautas P97 · Ajuste mobile + tema + pastas/baralho do acompanhamento */
(function(){
'use strict';
const BUILD='P97';
function inject(){
...
function boot(){
  ...
  window.CARBONAUTAS_RUNTIME_BUILD=BUILD;console.info('Carbonautas P97 acompanhamento em pastas/baralho carregado');
}
